...
import ru.yajaneya.webmarket.core.services.PayPalService;
...
//             Optional<ru.yajaneya.webmarket.core.entities.Order> orderOptional = ordersService.findById(orderId);
